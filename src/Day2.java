...
public class Day2 {
    ...
    //Only need to finish this method
    public static boolean isValidProductID(long productID) {
        //Part 1 answer
        String pID = productID + "";

        int halfLengthPID = pID.length()/2;
        String halfPID = pID.substring(halfLengthPID);

        if (halfPID.equals(pID.substring(0, halfLengthPID))) {
            return true;
        }
